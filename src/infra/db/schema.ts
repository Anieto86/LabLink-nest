...
export const laboratoryStatus = pgEnum("laboratory_status", [
	"available",
	"in_use",
	"under_maintenance",
	"decommissioned",
...
export const equipment = pgTable(
	...
	(table) => [
		index("equipment_laboratory_id_idx").using(
			"btree",
...
export const experiments = pgTable(
	...
	(table) => [
		index("experiments_laboratory_id_idx").using(
			"btree",
			table.laboratoryId.asc().nullsLast().op("int8_ops")
		),
		foreignKey({
...
export const formTemplateVersions = pgTable(
	"form_template_versions",
	{
		// You can use { mode: "bigint" } if numbers are exceeding js number limitations
		id: bigint({ mode: "number" }).primaryKey().generatedAlwaysAsIdentity({
			name: "form_template_versions_id_seq",
			startWith: 1,
			increment: 1,
			minValue: 1,
			maxValue: 9223372036854775807,
	...
	(table) => [
		index("ftv_form_template_id_idx").using(
			"btree",
			table.formTemplateId.asc().nullsLast().op("int8_ops")
		),
		foreignKey({
...
export const formTemplates = pgTable(
	...
	(table) => [
		index("form_templates_created_by_idx").using(
			"btree",
			table.createdBy.asc().nullsLast().op("int8_ops")
		),
		index("form_templates_structure_gin_idx").using(
			"gin",
			table.structure.asc().nullsLast().op("jsonb_ops")
		),
		foreignKey({
...
export const experimentRecords = pgTable(
	"experiment_records",
	{
		// You can use { mode: "bigint" } if numbers are exceeding js number limitations
		id: bigint({ mode: "number" }).primaryKey().generatedAlwaysAsIdentity({
			name: "experiment_records_id_seq",
			startWith: 1,
			increment: 1,
			minValue: 1,
			maxValue: 9223372036854775807,
	...
	(table) => [
		index("experiment_records_data_gin_idx").using(
			"gin",
			table.data.asc().nullsLast().op("jsonb_path_ops")
		),
		index("experiment_records_experiment_id_idx").using(
			"btree",
			table.experimentId.asc().nullsLast().op("int8_ops")
		),
		index("experiment_records_form_template_version_id_idx").using(
			"btree",
			table.formTemplateVersionId.asc().nullsLast().op("int8_ops")
		),
		index("experiment_records_user_id_idx").using(
			"btree",
...
export const laboratoryMembers = pgTable(
	"laboratory_members",
	{
		// You can use { mode: "bigint" } if numbers are exceeding js number limitations
		id: bigint({ mode: "number" }).primaryKey().generatedAlwaysAsIdentity({
			name: "laboratory_members_id_seq",
			startWith: 1,
			increment: 1,
			minValue: 1,
			maxValue: 9223372036854775807,
	...
	(table) => [
		index("lab_members_laboratory_id_idx").using(
			"btree",
			table.laboratoryId.asc().nullsLast().op("int8_ops")
		),
...
export const experimentRecordFiles = pgTable(
	"experiment_record_files",
	{
		// You can use { mode: "bigint" } if numbers are exceeding js number limitations
		id: bigint({ mode: "number" }).primaryKey().generatedAlwaysAsIdentity({
			name: "experiment_record_files_id_seq",
			startWith: 1,
			increment: 1,
			minValue: 1,
			maxValue: 9223372036854775807,
	...
	(table) => [
		index("erf_record_id_idx").using(
			"btree",
			table.experimentRecordId.asc().nullsLast().op("int8_ops")
		),
		foreignKey({
...
export const experimentStatusHistory = pgTable(
	"experiment_status_history",
	{
		// You can use { mode: "bigint" } if numbers are exceeding js number limitations
		id: bigint({ mode: "number" }).primaryKey().generatedAlwaysAsIdentity({
			name: "experiment_status_history_id_seq",
			startWith: 1,
			increment: 1,
			minValue: 1,
			maxValue: 9223372036854775807,
	...
	(table) => [
		index("experiment_status_history_experiment_id_idx").using(
			"btree",
			table.experimentId.asc().nullsLast().op("int8_ops")
		),
		foreignKey({
...
export const auditLogs = pgTable(
	...
	(table) => [
		index("audit_logs_entity_idx").using(
			"btree",
			table.entityType.asc().nullsLast().op("int8_ops"),
...
export const resources = pgTable(
	...
	(table) => [
		index("resources_laboratory_id_idx").using(
			"btree",
			table.laboratoryId.asc().nullsLast().op("int8_ops")
		),
...
export const reservations = pgTable(
	...
	(table) => [
		index("reservations_resource_id_idx").using(
			"btree",
